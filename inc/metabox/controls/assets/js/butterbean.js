( function() {
	...
	butterbean.views.register_control( 'range', {
		...
		ready: function() {
			...
			var lqthemes_range_input_number_timeout;

			function lqthemes_autocorrect_range_input_number( input_number, timeout ) {
				...
				clearTimeout( lqthemes_range_input_number_timeout );

				lqthemes_range_input_number_timeout = setTimeout( function() {
			...
			jQuery( 'input.hoocompanion-range-input' ).on( 'change keyup', function() {
				...
				lqthemes_autocorrect_range_input_number( jQuery( this ), 1000);

			} ).on( 'focusout', function() {

				lqthemes_autocorrect_range_input_number( jQuery( this ), 0);
