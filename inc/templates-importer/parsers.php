 ...
 */
class LQThemes_WXR_Parser {
	function parse( $file ) {
		// Attempt to use proper XML parsers first
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new LQThemes_WXR_Parser_SimpleXML;
			...
			$parser = new LQThemes_WXR_Parser_XML;
			$result = $parser->parse( $file );
		...
		$parser = new LQThemes_WXR_Parser_Regex;
 ...
 */
class LQThemes_WXR_Parser_SimpleXML {
	function parse( $file ) {
 ...
 */
class LQThemes_WXR_Parser_Regex {
	var $authors = array();
	var $posts = array();
