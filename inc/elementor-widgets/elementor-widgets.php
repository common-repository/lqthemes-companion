...
function lqthemes_add_elementor_widget_categories( $elements_manager ) {

	$elements_manager->add_category(
		'lqthemes-elements',
		[
			'title' => __( 'LQThemes Elements', 'lqthemes-companion' ),
			'icon' => 'fa fa-plug',
		]
	);
...
add_action( 'elementor/elements/categories_registered', 'lqthemes_add_elementor_widget_categories' );
